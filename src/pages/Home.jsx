    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-cyan-50 dark:from-gray-900 dark:via-slate-900 dark:to-gray-800 relative overflow-hidden">
      ...
      <div className="lg:hidden relative px-4 pt-4 pb-8">
        <div className="space-y-4">
          {/* Mobile Hero Card */}
          <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-2xl p-4 shadow-xl border border-white/20 dark:border-gray-700/20">
            <div className="inline-flex items-center px-3 py-1 bg-gradient-to-r from-blue-500/10 to-purple-600/10 text-blue-600 dark:text-blue-400 rounded-full text-xs font-semibold mb-3">
              <FiTrendingUp className="mr-1 w-3 h-3" />
              Smart Booking
            </div>

            <h1 className="text-2xl font-black text-gray-900 dark:text-white leading-tight mb-1">
              Simplify Your
            </h1>
            <h1 className="text-2xl font-black bg-gradient-to-r from-blue-600 via-purple-600 to-cyan-600 bg-clip-text text-transparent leading-tight mb-3">
              Slot Booking
            </h1>

            <p className="text-sm text-gray-600 dark:text-gray-300 mb-4 leading-relaxed">
              Intelligent booking platform for modern scheduling.
            </p>

            <a
              href="#calendar-mobile"
              onClick={(e) => {
                e.preventDefault();
                document.getElementById('calendar-mobile')?.scrollIntoView({ behavior: 'smooth', block: 'start' });
              }}
              className="w-full inline-flex items-center justify-center bg-gradient-to-r from-blue-600 via-purple-600 to-cyan-600 text-white px-4 py-2.5 rounded-xl transition-all duration-300 font-bold text-sm shadow-lg"
            >
              Get Started
            ...
            {/* Mobile Stats */}
            <div className="grid grid-cols-3 gap-3 mt-4 pt-4 border-t border-gray-200/50 dark:border-gray-600/50">
              <div className="text-center">
                <div className="text-xl font-black bg-gradient-to-r from-green-500 to-emerald-600 bg-clip-text text-transparent">99%</div>
                <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">Uptime</div>
              </div>
              <div className="text-center">
                <div className="text-xl font-black bg-gradient-to-r from-blue-500 to-cyan-600 bg-clip-text text-transparent">24/7</div>
                <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">Support</div>
              </div>
              <div className="text-center">
                <div className="text-xl font-black bg-gradient-to-r from-purple-500 to-pink-600 bg-clip-text text-transparent">Fast</div>
                <div className="text-xs text-gray-500 dark:text-gray-400 mt-1">Setup</div>
              </div>
            </div>
          </div>

          {/* Mobile Calendar */}
          <div id="calendar-mobile" className="bg-white/80 dark:bg-gray-800/80 backdrop-blur-xl rounded-2xl p-3 shadow-xl border border-white/20 dark:border-gray-700/20 scroll-mt-20">
      ...
      <div className="hidden lg:block relative max-w-[1800px] mx-auto px-8 pt-8 pb-20">
            ...
            <div className="bg-white/70 dark:bg-gray-800/70 backdrop-blur-xl rounded-3xl p-8 shadow-2xl border border-white/20 dark:border-gray-700/20 hover:shadow-3xl transition-all duration-500 transform hover:-translate-y-1 h-full flex flex-col justify-between">
              <div className="space-y-8">
                ...
                <div className="space-y-4">
                  ...
                  <h1 className="text-4xl md:text-5xl lg:text-6xl font-black bg-gradient-to-r from-blue-600 via-purple-600 to-cyan-600 bg-clip-text text-transparent leading-tight">
                    Slot Booking
                  </h1>
                </div>
              ...
              {/* Enhanced Stats */}
              <div className="grid grid-cols-3 gap-6 pt-8 mt-8 border-t border-gray-200/50 dark:border-gray-600/50">
                <div className="text-center group">
                  <div className="text-3xl lg:text-4xl font-black bg-gradient-to-r from-green-500 to-emerald-600 bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-300">99%</div>
                  <div className="text-sm text-gray-500 dark:text-gray-400 mt-2 font-semibold">Uptime</div>
                </div>
                <div className="text-center group">
                  <div className="text-3xl lg:text-4xl font-black bg-gradient-to-r from-blue-500 to-cyan-600 bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-300">24/7</div>
                  <div className="text-sm text-gray-500 dark:text-gray-400 mt-2 font-semibold">Support</div>
                </div>
                <div className="text-center group">
                  <div className="text-3xl lg:text-4xl font-black bg-gradient-to-r from-purple-500 to-pink-600 bg-clip-text text-transparent group-hover:scale-110 transition-transform duration-300">Fast</div>
      ...
      <div className="relative bg-gradient-to-r from-blue-600 via-purple-600 to-cyan-600 py-12 lg:py-32 overflow-hidden">
        ...
        <div className="hidden lg:block absolute top-10 left-10 w-20 h-20 bg-white/10 rounded-full blur-xl animate-bounce delay-1000"></div>
        <div className="hidden lg:block absolute bottom-10 right-10 w-32 h-32 bg-white/10 rounded-full blur-xl animate-bounce delay-500"></div>
        <div className="hidden lg:block absolute top-1/2 left-1/4 w-16 h-16 bg-white/10 rounded-full blur-xl animate-bounce delay-2000"></div>
        
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="inline-flex items-center px-3 py-1.5 lg:px-6 lg:py-3 bg-white/20 backdrop-blur-sm text-white rounded-full text-xs lg:text-lg font-bold shadow-2xl border border-white/30 mb-4 lg:mb-8">
            <FiUsers className="mr-1.5 lg:mr-3 w-4 h-4 lg:w-6 lg:h-6" />
            Join Thousands of Happy Users
          </div>
          
          <h2 className="text-3xl lg:text-6xl font-black text-white mb-4 lg:mb-8 drop-shadow-2xl leading-tight px-2">
            Ready to Get Started?
          </h2>
          <p className="text-sm lg:text-2xl text-blue-50 mb-8 lg:mb-16 max-w-3xl mx-auto drop-shadow-lg leading-relaxed font-medium px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3 lg:gap-6 justify-center items-center px-4">
            <a
              href="/login"
              className="w-full sm:w-auto group relative inline-flex items-center justify-center bg-white text-blue-600 px-6 py-3 lg:px-12 lg:py-6 rounded-xl lg:rounded-2xl hover:bg-gray-50 transition-all duration-300 shadow-2xl hover:shadow-3xl font-black text-sm lg:text-xl transform hover:-translate-y-1 hover:scale-105 overflow-hidden"
            >
              <div className="absolute inset-0 bg-gradient-to-r from-blue-50 to-purple-50 opacity-0 group-hover:opacity-100 transition-opacity duration-300 rounded-xl lg:rounded-2xl"></div>
              <span className="relative z-10">Go to Login</span>
              <svg className="relative z-10 ml-2 lg:ml-3 w-4 h-4 lg:w-6 lg:h-6 group-hover:translate-x-1 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 7l5 5m0 0l-5 5m5-5H6" />
              </svg>
            </a>
            ...
            <a
              href="/about"
              className="w-full sm:w-auto group inline-flex items-center justify-center border-2 border-white/50 text-white bg-white/10 backdrop-blur-sm px-6 py-3 lg:px-12 lg:py-6 rounded-xl lg:rounded-2xl hover:bg-white/20 hover:border-white/80 transition-all duration-300 font-black text-sm lg:text-xl shadow-xl hover:shadow-2xl transform hover:-translate-y-1"
            >
              Learn More
              <FiShield className="ml-2 lg:ml-3 w-4 h-4 lg:w-6 lg:h-6 group-hover:rotate-12 transition-transform duration-300" />
            </a>
          </div>
          
          {/* Trust indicators */}
          <div className="mt-8 lg:mt-16 flex flex-wrap justify-center items-center gap-4 lg:gap-8 opacity-80 px-4">
            <div className="flex items-center text-white/80 text-xs lg:text-lg font-semibold">
              <FiShield className="mr-1.5 lg:mr-2 w-4 h-4 lg:w-6 lg:h-6" />
              Enterprise Security
            </div>
            <div className="flex items-center text-white/80 text-xs lg:text-lg font-semibold">
              <FiCheckCircle className="mr-1.5 lg:mr-2 w-4 h-4 lg:w-6 lg:h-6" />
              99.9% Uptime
            </div>
            <div className="flex items-center text-white/80 text-xs lg:text-lg font-semibold">
              <FiClock className="mr-1.5 lg:mr-2 w-4 h-4 lg:w-6 lg:h-6" />
              24/7 Support
            </div>
          </div>
        </div>
